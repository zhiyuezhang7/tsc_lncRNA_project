...
# Example command:
    # sbatch 230301_3pr_kallisto.sh $1
    # $1 = rbp name (all lower cases) e.g., alyref


# start in empty directory with only this script; do following work in $1_kallisto
mkdir $1_kallisto
cd $1_kallisto

## Move input files to current directory
