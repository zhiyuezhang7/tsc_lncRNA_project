...
featureCounts -s 2 -F SAF -a $1_peaks.saf -o $1_fc /proj/calabrlb/users/Zhiyue/22_sp/rip_sam/$1_Aligned_filteredsq30.out.sam
...
cp $1_peaks_2igg_classified.txt /proj/calabrlb/users/Zhiyue/22_sp/rip_peaks_2igg_classified/